...
var _user$project$IPAddress$byteParser = A2(
	_Bogdanp$elm_combine$Combine$andThen,
	_Bogdanp$elm_combine$Combine_Num$int,
	function (x) {
		return ((_elm_lang$core$Native_Utils.cmp(x, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(x, 255) < 1)) ? _Bogdanp$elm_combine$Combine$succeed(x) : _Bogdanp$elm_combine$Combine$fail(
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _user$project$IPAddress$ipAddressParser = A2(
	_Bogdanp$elm_combine$Combine$andThen,
	_user$project$IPAddress$byteParser,
	function (a) {
		return A2(
			_Bogdanp$elm_combine$Combine$andThen,
										...
										return A2(
											...
											function (_p2) {
												return A2(
													...
													function (d) {
														return _Bogdanp$elm_combine$Combine$succeed(
															(((a * Math.pow(2, 24)) + (b * Math.pow(2, 16))) + (c * Math.pow(2, 8))) + d);
													});
											});
									});
							});
...
var _user$project$IPAddress$parseIPAddress = function (_p3) {
	return _elm_lang$core$Result$toMaybe(
		_elm_lang$core$Basics$fst(
			A2(_Bogdanp$elm_combine$Combine$parse, _user$project$IPAddress$ipAddressParser, _p3)));
};
var _user$project$IPAddress$toString = function (ip) {
	var d = A2(_elm_lang$core$Bitwise$and, ip, 255);
	var c = A2(
		_elm_lang$core$Bitwise$and,
		A2(_elm_lang$core$Bitwise$shiftRight, ip, 8),
		255);
	var b = A2(
		_elm_lang$core$Bitwise$and,
		A2(_elm_lang$core$Bitwise$shiftRight, ip, 16),
		255);
	var a = A2(
		_elm_lang$core$Bitwise$and,
		A2(_elm_lang$core$Bitwise$shiftRight, ip, 24),
		255);
	return function (_p4) {
		return A2(
			_elm_lang$core$String$join,
			'.',
			A2(_elm_lang$core$List$map, _elm_lang$core$Basics$toString, _p4));
	}(
		_elm_lang$core$Native_List.fromArray(
			[a, b, c, d]));
};

var _user$project$Firewall$routerPublicAddressStr = '53.0.0.1';
var _user$project$Firewall$routerPublicAddress = A2(
	_elm_lang$core$Maybe$withDefault,
	0,
	_user$project$IPAddress$parseIPAddress(_user$project$Firewall$routerPublicAddressStr));
var _user$project$Firewall$isLocalIP = function (ip) {
	var upperBound = A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		_user$project$IPAddress$parseIPAddress('10.255.255.255'));
	var lowerBound = A2(
		_elm_lang$core$Maybe$withDefault,
		0,
		_user$project$IPAddress$parseIPAddress('10.0.0.0'));
	return (_elm_lang$core$Native_Utils.cmp(ip, lowerBound) > -1) && (_elm_lang$core$Native_Utils.cmp(ip, upperBound) < 1);
};
var _user$project$Firewall$isExternalIP = function (_p0) {
	return _elm_lang$core$Basics$not(
		_user$project$Firewall$isLocalIP(_p0));
};
var _user$project$Firewall$isValidPort = function (port$) {
	return (_elm_lang$core$Native_Utils.cmp(port$, 0) > -1) && (_elm_lang$core$Native_Utils.cmp(port$, 65535) < 1);
};
var _user$project$Firewall$splitLine = function (str) {
	var _p1 = A2(_elm_lang$core$String$split, ' ', str);
	if (((((_p1.ctor === '::') && (_p1._1.ctor === '::')) && (_p1._1._1.ctor === '::')) && (_p1._1._1._1.ctor === '::')) && (_p1._1._1._1._1.ctor === '[]')) {
		var destinationPort$ = function (_p2) {
			return _elm_lang$core$Result$toMaybe(
				_elm_lang$core$String$toInt(_p2));
		}(_p1._1._1._1._0);
		var destinationIp$ = _user$project$IPAddress$parseIPAddress(_p1._1._1._0);
		var sourcePort$ = function (_p3) {
			return _elm_lang$core$Result$toMaybe(
				_elm_lang$core$String$toInt(_p3));
		}(_p1._1._0);
		var sourceIp$ = _user$project$IPAddress$parseIPAddress(_p1._0);
		return A5(
...
var _user$project$Firewall$parseLine = F2(
	function (_p4, line) {
		var _p5 = _p4;
		var _p14 = _p5.redirects;
		var _p13 = _p5.port$;
		var _p12 = _p5.mappings;
		var _p11 = _p5;
		var _p6 = _user$project$Firewall$splitLine(line);
		if (_p6.ctor === 'Just') {
			var _p10 = _p6._0._0;
			var _p9 = _p6._0._3;
			var _p8 = _p6._0._2;
			var fullDestination = A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$IPAddress$toString(_p8),
				A2(
					_elm_lang$core$Basics_ops['++'],
					':',
			...
			var fullSource = A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$IPAddress$toString(_p10),
				A2(
					_elm_lang$core$Basics_ops['++'],
					':',
					_elm_lang$core$Basics$toString(_p6._0._1)));
			if (_user$project$Firewall$isLocalIP(_p10) && _elm_lang$core$Native_Utils.eq(_p8, _user$project$Firewall$routerPublicAddress)) {
				return {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _p11};
			} else {
				if (_user$project$Firewall$isLocalIP(_p10) && _user$project$Firewall$isLocalIP(_p8)) {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Maybe$Just(
							A2(
								...
								' ',
								_elm_lang$core$Native_List.fromArray(
									[fullSource, fullDestination, 'local']))),
						_1: _p11
					};
				} else {
					if (_elm_lang$core$Native_Utils.eq(_p8, _user$project$Firewall$routerPublicAddress)) {
						var key = A2(
							_elm_lang$core$Basics_ops['++'],
							fullSource,
							A2(
								...
								A2(
									_elm_lang$core$Basics_ops['++'],
									_user$project$Firewall$routerPublicAddressStr,
									A2(
										_elm_lang$core$Basics_ops['++'],
										':',
										_elm_lang$core$Basics$toString(_p9)))));
						var _p7 = A2(_elm_lang$core$Dict$get, key, _p14);
						if (_p7.ctor === 'Just') {
							return {
								ctor: '_Tuple2',
								_0: _elm_lang$core$Maybe$Just(
									A2(
										...
										' ',
										_elm_lang$core$Native_List.fromArray(
											['Accept', fullSource, fullDestination, 'redirect', _p7._0]))),
								_1: _p11
							};
						} else {
							return {
								...
								_0: _elm_lang$core$Maybe$Just(
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											fullSource,
											A2(_elm_lang$core$Basics_ops['++'], ' ', fullDestination)))),
								_1: _p11
							};
						}
					} else {
						if (_user$project$Firewall$isLocalIP(_p10) && _user$project$Firewall$isExternalIP(_p8)) {
							var key = A2(
								_elm_lang$core$Basics_ops['++'],
								fullSource,
								A2(_elm_lang$core$Basics_ops['++'], '-', fullDestination));
							if (A2(_elm_lang$core$Dict$member, key, _p12)) {
								return {ctor: '_Tuple2', _0: _elm_lang$core$Maybe$Nothing, _1: _p11};
							} else {
								var redirectKey = A2(
									_elm_lang$core$Basics_ops['++'],
								...
								var config$ = {
									port$: _p13 + 1,
									mappings: A3(_elm_lang$core$Dict$insert, key, _p13, _p12),
									redirects: A3(_elm_lang$core$Dict$insert, redirectKey, fullSource, _p14)
								};
								var str = A2(
									_elm_lang$core$String$join,
									' ',
								...
								return {
									ctor: '_Tuple2',
									_0: _elm_lang$core$Maybe$Just(str),
									_1: config$
								};
							}
						} else {
...
var _user$project$Firewall$defaultConfig = {
	port$: 1025,
	mappings: _elm_lang$core$Dict$fromList(
		_elm_lang$core$Native_List.fromArray(
			[])),
	redirects: _elm_lang$core$Dict$fromList(
		_elm_lang$core$Native_List.fromArray(
			[]))
};
var _user$project$Firewall$parseLines = function (lines) {
		...
		A3(
			...
			F2(
				function (line, _p15) {
					var _p16 = _p15;
					var _p19 = _p16._0;
					var _p17 = A2(_user$project$Firewall$parseLine, _p16._1, line);
					var output$ = _p17._0;
					var config$ = _p17._1;
					var _p18 = output$;
					if (_p18.ctor === 'Just') {
						...
						return {ctor: '_Tuple2', _0: _p19, _1: config$};
					}
				}),
			{ctor: '_Tuple2', _0: '', _1: _user$project$Firewall$defaultConfig},
			_elm_lang$core$String$lines(lines)));
};
var _user$project$Firewall$Config = F3(
	function (a, b, c) {
		return {port$: a, mappings: b, redirects: c};
	});

var _user$project$Main$inputTextAreaStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'width', _1: '100%'},
			{ctor: '_Tuple2', _0: 'font-family', _1: 'monospace'}
		]));
var _user$project$Main$bodyStyle = _elm_lang$html$Html_Attributes$style(
	_elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: 'margin', _1: '0 auto'},
			{ctor: '_Tuple2', _0: 'width', _1: '600px'},
			{ctor: '_Tuple2', _0: 'font-family', _1: 'Helvetica, Arial, sans-serif'}
		]));
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ParseInput') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{input: model.tempInput});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{tempInput: _p0._0});
...
var _user$project$Main$initInput = A2(
	_elm_lang$core$String$join,
	'\n',
	_elm_lang$core$Native_List.fromArray(
		['10.0.0.1 1025 73.53.53.2 53', '10.0.0.1 1025 73.53.53.2 53', '10.0.0.1 1027 73.52.51.1 88', '10.0.0.2 1027 73.52.51.1 88', '10.0.0.2 1027 73.52.51.1 89', '10.0.0.1 1026 10.0.0.2 53', '10.0.0.1 1026 53.0.0.1 53', '73.53.53.2 53 53.0.0.1 1025', '73.53.53.2 53 53.0.0.1 53', '73.53.53.1 53 53.0.0.1 1025']));
var _user$project$Main$initModel = {input: _user$project$Main$initInput, tempInput: _user$project$Main$initInput};
var _user$project$Main$Model = F2(
	function (a, b) {
		return {input: a, tempInput: b};
	});
var _user$project$Main$SetTempInput = function (a) {
	return {ctor: 'SetTempInput', _0: a};
};
var _user$project$Main$ParseInput = {ctor: 'ParseInput'};
var _user$project$Main$view = function (_p1) {
	var _p2 = _p1;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[_user$project$Main$bodyStyle]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Input:')
					])),
				A2(
				_elm_lang$html$Html$textarea,
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$Main$inputTextAreaStyle,
						_elm_lang$html$Html_Attributes$value(_p2.tempInput),
						_elm_lang$html$Html_Attributes$rows(10),
						_elm_lang$html$Html_Events$onInput(_user$project$Main$SetTempInput)
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Main$ParseInput)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								return _elm_lang$html$Html$text(
									_user$project$Firewall$parseLines(_p3));
							}(_p2.input)
							]))
					]))
			]));
...
var Elm = {};
Elm['Firewall'] = Elm['Firewall'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Firewall'], 'Firewall', typeof _user$project$Firewall$main === 'undefined' ? null : _user$project$Firewall$main);
Elm['IPAddress'] = Elm['IPAddress'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['IPAddress'], 'IPAddress', typeof _user$project$IPAddress$main === 'undefined' ? null : _user$project$IPAddress$main);
Elm['Main'] = Elm['Main'] || {};
